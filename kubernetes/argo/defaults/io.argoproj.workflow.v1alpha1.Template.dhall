...
, volumes =
    [] : List
           (   ./../types/io.k8s.api.core.v1.Volume.dhall
                 sha256:aa2b222238a29017213aabfe42fa65f41b8d1301bc48e4a06ff1cc0cc3be7149
             ? ./../types/io.k8s.api.core.v1.Volume.dhall
           )
...
, affinity =
    None
      (   ./../types/io.k8s.api.core.v1.Affinity.dhall
            sha256:bd97be75b0c9c603b8be60ab063f5ddfcc9088db0dde7d0cddb8ff227cdde90a
        ? ./../types/io.k8s.api.core.v1.Affinity.dhall
      )
, container =
    None
      (   ./../types/io.k8s.api.core.v1.Container.dhall
            sha256:77b5385109379be9fa23ee6d0a576774c9b153b79de9ea1cdd942291cf33dc71
        ? ./../types/io.k8s.api.core.v1.Container.dhall
      )
, daemon = None Bool
, dag =
